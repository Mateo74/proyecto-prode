...
const I18n = (() => {
  ...
  'match.extraHalfTimeShort':'DP',
      ...
      'tab.matchPredictions':  'Predicciones',
      'tab.matchStats':        'Estadísticas',
      ...
      'groups.actualPointsTitle': 'Puntos (resultados reales)',
      'groups.predicted':    'Pred',
      'groups.predictedTitle': 'Puntos predichos',
      'groups.playingNow':   'Jugando ahora',
      ...
      'ko.stage.group': 'Fase de grupos',
      'ko.stage.r32':   'Dieciseisavos',
      ...
      'ko.locked':      'Se desbloquea cuando terminen los partidos y se conozcan los clasificados.',
      'ko.tbd':         'Por definir',
      'ko.thirdShort':  '3º',
      'ko.winnerShort': 'G',
      ...
      'match.vs':               'vs',
      'match.stats.availableWhenLocked': 'Las estadísticas se muestran cuando se cierran las predicciones del partido.',
      'match.stats.noPredictions':       'Todavía no hay predicciones para mostrar estadísticas.',
      'match.stats.avgPredictedScore':   'Promedio de marcador predicho',
      'match.stats.outcomeDistribution': 'Resultados predichos',
      'match.stats.commonPredictions':   'Predicciones más comunes',
      'match.stats.extremePredictions':  'Predicciones extremas',
      'match.stats.homeWin':             '{{team}} gana',
      'match.stats.draw':                'Empate',
      'match.stats.awayWin':             'Gana {{team}}',
      'match.stats.homeSide':            'Local',
      'match.stats.awaySide':            'Visitante',
      'match.stats.other':               'Otro',
      'match.stats.none':                'Ninguna',
      'match.stats.by':                  'Por {{name}}',
  ...
  'match.extraHalfTimeShort':'BT',
      ...
      'tab.matchPredictions':  'Predictions',
      'tab.matchStats':        'Stats',
      'tab.matches':           'Matches',
      'tab.groups':            'Groups',
      ...
      'groups.actualPointsTitle': 'Points (real results)',
      'groups.predicted':    'Pred',
      'groups.predictedTitle': 'Predicted points',
      'groups.playingNow':   'Playing now',
      ...
      // ── Knockout bracket ──────────────────────────────────────────
      'ko.stage.group': 'Group stage',
      'ko.stage.r32':   'Round of 32',
      ...
      'ko.locked':      'Unlocks once the feeding games end and the qualified teams are known.',
      'ko.tbd':         'TBD',
      'ko.thirdShort':  '3rd',
      'ko.winnerShort': 'W',
      ...
      'match.vs':               'vs',
      'match.stats.availableWhenLocked': 'Stats appear once match predictions are locked.',
      'match.stats.noPredictions':       'There are no predictions yet to build stats.',
      'match.stats.avgPredictedScore':   'Average predicted score',
      'match.stats.outcomeDistribution': 'Predicted outcomes',
      'match.stats.commonPredictions':   'Most common predictions',
      'match.stats.extremePredictions':  'Extreme predictions',
      'match.stats.homeWin':             '{{team}} win',
      'match.stats.draw':                'Draw',
      'match.stats.awayWin':             '{{team}} win',
      'match.stats.homeSide':            'Home',
      'match.stats.awaySide':            'Away',
      'match.stats.other':               'Other',
      'match.stats.none':                'None',
      'match.stats.by':                  'By {{name}}',
