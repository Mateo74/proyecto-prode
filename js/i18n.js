...
const I18n = (() => {
  ...
  const STRINGS = {
    ...
    en: {
      ...
      'nav.friendTournaments':   'Friend Tournaments',
      ...
      'page.tournaments':   'Friend Tournaments',
      'page.ranking':       'Ranking',
      'page.signIn':        'Sign in',
      ...
      'tab.friendTournaments': 'Friend Tournaments',
      ...
      'empty.signInForTorneos':  'Sign in to see Friend Tournaments.',
      'empty.noTorneosForComp':  "You're not part of any Friend Tournament for this competition yet.",
      'empty.noTorneos':         "You're not part of any Friend Tournament yet. Create one or request an invite!",
      'empty.noPendingPreds':    'You have no pending predictions.',
      'empty.noHistory':         'No prediction history yet.',
      'empty.chooseTorneo':      'Choose a Friend Tournament.',
      'empty.signInForPreds':    'Sign in to see your predictions.',
      'empty.chooseTorneoRank':  'Choose a Friend Tournament to see the ranking.',
      'empty.noScoresYet':       'No scores yet in this tournament.',
      'empty.chooseTorneoMatch': 'Choose a Friend Tournament to see upcoming matches.',
      ...
      'empty.signInForTorneoPage':'Sign in to see your Friend Tournaments',
