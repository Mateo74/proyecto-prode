...
const I18n = (() => {
  ...
  'match.extraHalfTimeShort':'DP',
      ...
      'match.vs':               'vs',
      'match.stats.availableWhenLocked': 'Las estadísticas estarán disponibles cuando empiece el partido.',
      'match.stats.noPredictions':       'Todavía no hay predicciones para mostrar estadísticas.',
      'match.stats.avgPredictedScore':   'Predicción promedio',
  ...
  'match.extraHalfTimeShort':'BT',
      ...
      'match.vs':               'vs',
      'match.stats.availableWhenLocked': 'Stats become available when the match starts.',
      'match.stats.noPredictions':       'There are no predictions yet to build stats.',
      'match.stats.avgPredictedScore':   'Average prediction',
